...
def validate_localization() -> None:
    ...
    exact_localization = {
        "eng": {
            f"{prefix}TRIAL.pages.INITIAL.options.RYOMA.title": "Ryoma: [red]You are all guilty.[/red]",
            ...
            f"{prefix}THE_LEGENDS_WERE_TRUE.pages.INITIAL.options.HAYATO.title": "Hayato: [white]Take another route.[/white]",
            ...
            f"{prefix}SPIRALING_WHIRLPOOL.pages.INITIAL.options.HAYATO.title": "Hayato: [white]Unmake one completed record and reverse-engineer its structure.[/white]",
        ...
        "jpn": {
            f"{prefix}TRIAL.pages.INITIAL.options.RYOMA.title": "竜馬：[red]お前たちは全員有罪だ。[/red]",
            ...
            f"{prefix}THE_LEGENDS_WERE_TRUE.pages.INITIAL.options.HAYATO.title": "隼人：[white]別の道を行く。[/white]",
            ...
            f"{prefix}SPIRALING_WHIRLPOOL.pages.INITIAL.options.HAYATO.title": "隼人：[white]完成した記録を一つ解き、その構造を逆算する。[/white]",
        ...
        "zhs": {
            f"{prefix}TRIAL.pages.INITIAL.options.RYOMA.title": "龙马：[red]你们都有罪[/red]",
            ...
            f"{prefix}THE_LEGENDS_WERE_TRUE.pages.INITIAL.options.HAYATO.title": "隼人：[white]换条路走。[/white]",
            ...
            f"{prefix}SPIRALING_WHIRLPOOL.pages.INITIAL.options.HAYATO.title": "隼人：[white]拆开一段完成记录，反推它的结构。[/white]",
