...
const REQUIRED_RESOURCES := {
	...
	"res://audio/music/shin_getter/album/dragon_sts2.ogg": false,
	"res://audio/music/shin_getter/album/storm_sts2.ogg": false,
	"res://images/ui/chunibyo/bgm_controls_atlas.png": false,
