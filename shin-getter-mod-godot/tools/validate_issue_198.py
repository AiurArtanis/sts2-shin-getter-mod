...
KEY = "S_G_C_SAINT_DRAGON_ROAR.description"
EXPECTED_PREFIXES = {
...
for language, expected_prefix in EXPECTED_PREFIXES.items():
    ...
    if not description.startswith(expected_prefix):
        raise AssertionError(f"issue#198: unexpected {language} Saint Dragon Roar scope")
...
card = (ROOT / "src/Models/Cards/SGC_SaintDragonRoar.cs").read_text(encoding="utf-8")
