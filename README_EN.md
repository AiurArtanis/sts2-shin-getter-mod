...
1. Download `ShinGetterMod.pck`, `ShinGetterMod.dll`, and `ShinGetterMod.json` from the [latest release](https://github.com/AiurArtanis/sts2-shin-getter-mod/releases/latest).
