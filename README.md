...
> 当前版本 `v1.0.0` · 最低游戏版本 `0.106.1` · Godot `4.5.1 Mono` · .NET `9` · 简体中文 / English / 日本語

[下载 V1.0.0](https://github.com/AiurArtanis/sts2-shin-getter-mod/releases/tag/V1.0.0) · [提交问题](https://github.com/AiurArtanis/sts2-shin-getter-mod/issues)
...
1. 从 [GitHub Release](https://github.com/AiurArtanis/sts2-shin-getter-mod/releases/tag/V1.0.0) 下载 `ShinGetterMod.pck`、`ShinGetterMod.dll` 与 `ShinGetterMod.json`。
