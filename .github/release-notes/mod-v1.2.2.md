...
v1.2.2：新增模组BGM总开关；更新23首可选曲目，新增5首BGM；调整事件战、巢穴精英战及处刑曲默认音乐，旧选曲失效时自动回退为预设。

## eng

### v1.2.2 release notes

- Added a master switch for mod battle BGM, execution themes, and previews; track choices are retained when disabled.
- Refreshed the 23-track BGM selection, adding Creation, Hostility, Forward, It's Time, and Bravery (Iron Saga Ver.).
...
v1.2.2: Added a master BGM switch; refreshed the 23-track selection with five new tracks; updated event, Hive elite, and execution music defaults. Invalid saved track choices now fall back to presets.

## jpn

### v1.2.2 更新内容

- 戦闘BGM・処刑曲・試聴をまとめて切り替えるMOD BGMスイッチを追加。オフにしても選曲は保持されます。
- 選択可能なBGMを23曲に更新し、「創造」「敵状」「前進」「今がその時だ」「勇壮（機動戰隊Ver.）」を追加。
